...
static void prefs_other_create_widget(PrefsPage *_page, GtkWindow *window, gpointer data)
{
	...
	keys_preset_label = gtk_label_new(_("Select preset keyboard shortcuts:"));
	...
	keys_preset_combo = combobox_text_new(FALSE, _("Current"), _("Default"), "Mew / Wanderlust", "Mutt", NULL);
