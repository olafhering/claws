...
int imap_threaded_search(Folder *folder, int search_type, IMAPSearchKey *key, const char *charset, struct mailimap_set *set, clist **result);

int imap_threaded_fetch_uid(Folder *folder, uint32_t first_index, carray **result);
