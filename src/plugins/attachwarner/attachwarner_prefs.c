...
static void attwarner_prefs_create_widget_func(PrefsPage *_page, GtkWindow *window, gpointer data)
{
	...
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(case_sensitive_checkbox), attwarnerprefs.case_sensitive);
	...
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(skip_quotes_checkbox), attwarnerprefs.skip_quotes);
	...
	CLAWS_SET_TIP(skip_fwd_redir_checkbox, _("Don't check for missing attachments when forwarding or redirecting messages"));
	...
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(skip_signature_checkbox), attwarnerprefs.skip_signature);
...
static void attwarner_prefs_save_func(PrefsPage *_page)
{
	...
	attwarnerprefs.skip_quotes = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(page->skip_quotes_checkbox));
	attwarnerprefs.skip_forwards_and_redirections = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(page->skip_forwards_and_redirections));
	attwarnerprefs.skip_signature = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(page->skip_signature));
	attwarnerprefs.case_sensitive = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(page->case_sensitive_checkbox));
