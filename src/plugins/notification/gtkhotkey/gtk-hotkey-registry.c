...
GtkHotkeyRegistry *gtk_hotkey_registry_get_default(void)
{
	if (G_UNLIKELY(default_registry == NULL)) {
		...
		default_registry = GTK_HOTKEY_REGISTRY(g_object_new(GTK_HOTKEY_TYPE_KEY_FILE_REGISTRY, NULL));
...
GtkHotkeyInfo *gtk_hotkey_registry_get_hotkey(GtkHotkeyRegistry *self, const char *app_id, const char *key_id, GError **error)
{
	...
	return GTK_HOTKEY_REGISTRY_GET_CLASS(self)->get_hotkey(self, app_id, key_id, error);
}
...
{
	g_return_val_if_fail(GTK_HOTKEY_IS_REGISTRY(self), FALSE);
	return GTK_HOTKEY_REGISTRY_GET_CLASS(self)->delete_hotkey(self, app_id, key_id, error);
}
 ...
 */
void gtk_hotkey_registry_hotkey_stored(GtkHotkeyRegistry *self, GtkHotkeyInfo *info)
{
 ...
 * only be used by child classes of #GtkHotkeyRegistry.
 */
void gtk_hotkey_registry_hotkey_deleted(GtkHotkeyRegistry *self, GtkHotkeyInfo *info)
{
	g_return_if_fail(GTK_HOTKEY_IS_REGISTRY(self));
	GTK_HOTKEY_REGISTRY_GET_CLASS(self)->hotkey_deleted(self, info);
}

static void gtk_hotkey_registry_hotkey_stored_real(GtkHotkeyRegistry *self, GtkHotkeyInfo *info)
{
	g_return_if_fail(GTK_HOTKEY_IS_INFO(info));
	g_return_if_fail(GTK_HOTKEY_IS_REGISTRY(self));
...
static void gtk_hotkey_registry_hotkey_deleted_real(GtkHotkeyRegistry *self, GtkHotkeyInfo *info)
{
	g_return_if_fail(GTK_HOTKEY_IS_INFO(info));
	g_return_if_fail(GTK_HOTKEY_IS_REGISTRY(self));
...
static void gtk_hotkey_registry_class_init(GtkHotkeyRegistryClass *klass)
{
	 ...
	 */
	storage_signals[HOTKEY_STORED] = g_signal_new("hotkey_stored", GTK_HOTKEY_TYPE_STORAGE, G_SIGNAL_RUN_LAST, 0, NULL, NULL, g_cclosure_marshal_VOID__OBJECT, G_TYPE_NONE, 1, G_TYPE_OBJECT);
	 ...
	 */
	storage_signals[HOTKEY_DELETED] = g_signal_new("hotkey_deleted", GTK_HOTKEY_TYPE_STORAGE, G_SIGNAL_RUN_LAST, 0, NULL, NULL, g_cclosure_marshal_VOID__OBJECT, G_TYPE_NONE, 1, G_TYPE_OBJECT);
}

static void gtk_hotkey_registry_init(GtkHotkeyRegistry *self)
{

}

static void gtk_hotkey_registry_finalize(GtkHotkeyRegistry *self)
{
