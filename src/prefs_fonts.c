...
static void prefs_fonts_create_widget(PrefsPage *_page, GtkWindow *window, gpointer data)
{
	...
	gtk_table_attach(GTK_TABLE(table), tmplabel, 0, 1, row, row + 1, (GtkAttachOptions) GTK_FILL, (GtkAttachOptions) (0), 0, 0);
	...
	g_object_set(G_OBJECT(entry_folderview_normalfont), "use-font", TRUE, NULL);
	gtk_widget_show(entry_folderview_normalfont);
	gtk_table_attach(GTK_TABLE(table), entry_folderview_normalfont, 1, 2, row, row + 1, (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	row++;
	...
	g_object_set(G_OBJECT(entry_messageviewfont), "use-font", TRUE, NULL);
	gtk_widget_show(entry_messageviewfont);
	gtk_table_attach(GTK_TABLE(table), entry_messageviewfont, 1, 2, row, row + 1, (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	row++;

	vbox = gtk_vbox_new(FALSE, VSPACING_NARROW);
	gtk_widget_show(vbox);
	gtk_table_attach(GTK_TABLE(table), vbox, 0, 4, row, row + 1, (GtkAttachOptions) GTK_FILL, (GtkAttachOptions) (0), 0, 0);
	row++;
	...
	gtk_table_attach(GTK_TABLE(table), derive_from_normalfont_checkbutton, 0, 2, row, row + 1, (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(derive_from_normalfont_checkbutton), prefs_common.derive_from_normal_font);
	row++;
	...
	g_object_set(G_OBJECT(entry_folderview_smallfont), "use-font", TRUE, NULL);
	gtk_widget_show(entry_folderview_smallfont);
	gtk_table_attach(GTK_TABLE(table), entry_folderview_smallfont, 1, 2, row, row + 1, (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	...
	g_object_set(G_OBJECT(entry_folderview_boldfont), "use-font", TRUE, NULL);
	gtk_widget_show(entry_folderview_boldfont);
	gtk_table_attach(GTK_TABLE(table), entry_folderview_boldfont, 1, 2, row, row + 1, (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	...
	gtk_table_attach(GTK_TABLE(table), print_checkbutton, 0, 2, row, row + 1, (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(print_checkbutton), prefs_common.use_different_print_font);
	row++;
	...
	g_object_set(G_OBJECT(entry_messageprintfont), "use-font", TRUE, NULL);
	gtk_widget_show(entry_messageprintfont);
	gtk_table_attach(GTK_TABLE(table), entry_messageprintfont, 1, 2, row, row + 1, (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
...
static void prefs_fonts_save(PrefsPage *_page)
{
	...
	prefs_common.boldfont = g_strdup(gtk_font_button_get_font_name(GTK_FONT_BUTTON(fonts->entry_folderview_boldfont)));

	g_free(prefs_common.normalfont);
	prefs_common.normalfont = g_strdup(gtk_font_button_get_font_name(GTK_FONT_BUTTON(fonts->entry_folderview_normalfont)));

	g_free(prefs_common.smallfont);
	prefs_common.smallfont = g_strdup(gtk_font_button_get_font_name(GTK_FONT_BUTTON(fonts->entry_folderview_smallfont)));

	g_free(prefs_common.textfont);
	prefs_common.textfont = g_strdup(gtk_font_button_get_font_name(GTK_FONT_BUTTON(fonts->entry_messageviewfont)));

	prefs_common.derive_from_normal_font = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(fonts->derive_from_normalfont_checkbutton));

	g_free(prefs_common.printfont);
	prefs_common.printfont = g_strdup(gtk_font_button_get_font_name(GTK_FONT_BUTTON(fonts->entry_messageprintfont)));
	prefs_common.use_different_print_font = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(fonts->print_checkbutton));
