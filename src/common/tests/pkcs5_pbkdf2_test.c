...
static void test_pkcs5_pbkdf2(gconstpointer user_data)
{
	...
	if (g_test_verbose()) {
		g_printerr("input '%s' (%ld)\nsalt '%s' (%ld)\nlength %ld\nrounds %d\nexpected_return %d\n", data->input, data->input_length, data->salt, data->salt_length, data->length, data->rounds, data->expected_return);
	}

	ret = pkcs5_pbkdf2(data->input, data->input_length, data->salt, data->salt_length, kd, data->length, data->rounds);

	g_assert_cmpint(ret, ==, data->expected_return);
	g_assert_cmpstr(kd, ==, data->expected_output);
}

static void test_pkcs5_pbkdf2_null_output_buffer(void)
{
...
int main(int argc, char *argv[])
{
	...
	g_test_add_data_func("/common/pkcs5_pbkdf2/zero_rounds", &td_zero_rounds, test_pkcs5_pbkdf2);
	g_test_add_data_func("/common/pkcs5_pbkdf2/zero_output_length", &td_zero_output_length, test_pkcs5_pbkdf2);
	g_test_add_data_func("/common/pkcs5_pbkdf2/null_salt", &td_null_salt, test_pkcs5_pbkdf2);
	g_test_add_data_func("/common/pkcs5_pbkdf2/null_input", &td_null_input, test_pkcs5_pbkdf2);
	g_test_add_func("/common/pkcs5_pbkdf2/null_output_buffer", test_pkcs5_pbkdf2_null_output_buffer);

	g_test_add_data_func("/common/pkcs5_pbkdf2/rfc6070_1", &td_rfc6070_1, test_pkcs5_pbkdf2);
	g_test_add_data_func("/common/pkcs5_pbkdf2/rfc6070_2", &td_rfc6070_2, test_pkcs5_pbkdf2);
	g_test_add_data_func("/common/pkcs5_pbkdf2/rfc6070_3", &td_rfc6070_3, test_pkcs5_pbkdf2);
	g_test_add_data_func("/common/pkcs5_pbkdf2/rfc6070_4", &td_rfc6070_4, test_pkcs5_pbkdf2);
	g_test_add_data_func("/common/pkcs5_pbkdf2/rfc6070_5", &td_rfc6070_5, test_pkcs5_pbkdf2);
	g_test_add_data_func("/common/pkcs5_pbkdf2/rfc6070_6", &td_rfc6070_6, test_pkcs5_pbkdf2);
