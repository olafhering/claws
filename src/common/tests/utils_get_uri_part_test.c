...
static void test_utils_get_uri_part_nowhitespace()
{
	gboolean ret;
...
static void test_utils_get_uri_part_whitespace()
{
	gboolean ret;
...
static void test_utils_get_uri_part(gconstpointer user_data)
{
...
int main(int argc, char *argv[])
{
	...
	g_test_add_func("/common/utils/get_uri_part/nowhitespace", test_utils_get_uri_part_nowhitespace);
	g_test_add_func("/common/utils/get_uri_part/whitespace", test_utils_get_uri_part_whitespace);

	g_test_add_data_func("/common/utils/get_uri_part/basic", &td_get_uri_basic, test_utils_get_uri_part);
	g_test_add_data_func("/common/utils/get_uri_part/slash", &td_get_uri_slash, test_utils_get_uri_part);
	g_test_add_data_func("/common/utils/get_uri_part/question", &td_get_uri_question, test_utils_get_uri_part);
	g_test_add_data_func("/common/utils/get_uri_part/parenthesis", &td_get_uri_parenthesis, test_utils_get_uri_part);
	g_test_add_data_func("/common/utils/get_uri_part/brace", &td_get_uri_brace, test_utils_get_uri_part);
	g_test_add_data_func("/common/utils/get_uri_part/umlaut", &td_get_uri_umlaut, test_utils_get_uri_part);
	g_test_add_data_func("/common/utils/get_uri_part/kanji", &td_get_uri_kanji, test_utils_get_uri_part);
	g_test_add_data_func("/common/utils/get_uri_part/nonprintable", &td_get_uri_nonprintable, test_utils_get_uri_part);
