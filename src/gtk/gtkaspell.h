...
struct _WidgetContext {
	...
	void (*set_menu_pos)(GtkMenu *menu, gint *x, gint *y, gboolean *push_in, gpointer user_data);
...
GtkAspell *gtkaspell_new(const gchar *dictionary, const gchar *alt_dictionary, const gchar *encoding, gint misspelled_color, gboolean check_while_typing, gboolean recheck_when_changing_dict, gboolean use_alternate, gboolean use_both_dicts, GtkTextView *gtktext, GtkWindow *parent_win, void (*dict_changed_cd)(void *data), void(*spell_menu_cb)(void *data), void *data);
