...
struct _GtkCMUnitVtable {
	...
	gint (*unit_get_number_of_built_in_units)(void);
	 ...
	 GtkCMUnit(*unit_new) (gchar *identifier, gdouble factor, gint digits, gchar *symbol, gchar *abbreviation, gchar *singular, gchar *plural);
	gboolean (*unit_get_deletion_flag)(GtkCMUnit unit);
	void (*unit_set_deletion_flag)(GtkCMUnit unit, gboolean deletion_flag);
...
G_BEGIN_DECLS void gimp_base_init(GtkCMUnitVtable *vtable);
