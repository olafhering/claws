...
static void mark_all_read_unread_handler(GtkAction *action, gpointer data, gboolean recursive, gboolean read)
{
	...
	if (read) {
		...
		message = recursive ? _("Do you really want to mark all mails in this " "folder and its sub-folders as read?") : _("Do you really want to mark all mails in this " "folder as read?");
	} else {
		title = _("Mark all as unread");
		message = recursive ? _("Do you really want to mark all mails in this " "folder and its sub-folders as unread?") : _("Do you really want to mark all mails in this " "folder as unread?");
	}
