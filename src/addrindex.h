...
gint addrindex_setup_static_search(AddressDataSource *ds, const gchar *searchTerm, ItemFolder *folder, void *callBackEnd, void *callBackEntry);
...
gboolean addrindex_load_completion(gint (*callBackFunc)
				    (const gchar *, const gchar *, const gchar *, const gchar *, GList *), gchar *folderpath);

gboolean addrindex_load_person_attribute(const gchar *attr, gint (*callBackFunc)
